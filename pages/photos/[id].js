    ...
    <>
      {ispLoading ? (
        ...
        <div className="">
          ...
          <div className=" pt-2 w-full flex justify-center container lg:hidden">
            {
              <Image
          ...
          <div className="bg-white border container lg:hidden">
          ...
          {/* For Desktop Screen  */}
          <div className=" lg:flex-row justify-between container sm:flex-col hidden lg:flex">
            {/* Add Section  */}
            <div className="mt-8  ">
              <AddSection width={"200px"} height={"300px"} />
            </div>
            {/* Image Section  */}
            <div className="mt-8 flex flex-col lg:ml-10 w-3/5 px-8">
            ...
            <div className=" flex-col w-96 hidden lg:flex">
              ...
              <div className="mt-8 mb-5">
                <AddSection height={"200px"} width={"300px"} />
              </div>
              <hr className="mb-5 " />
          ...
          {/* PNG Info -- Mobile ------------------- */}
          <div className="bg-gray-50 container rounded-md border w-96 h-40 mt-5 lg:hidden">
            <div className="bg-gray-200 border-l-4 pl-2 border-l-indigo-500 ">
              PNG info
            </div>
            <div className="flex flex-row justify-between px-4 mt-2">
          ...
          <div className="container py-2">
            <AddSection height={"200px"} width={"500px"} />
          </div>
          <div className=" text-center text-xl font-sans font-semibold mt-6">
            Related Png Images
          </div>
          <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 container mt-5">
